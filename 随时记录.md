...
4. 如果html涉及到后端语言,就按照后端语言渲染了返回
5. 如果有ajax请求的话,后台会根据配置的路由进行选择,然后转发到真实的后台服务器
6. 给前端的后端地址都是一个IP，但是需要前端配置不同的hosts，
...
model是双向绑定
  ...
  添加items时候,会绑定dom改变的事件函数,比如input对应change.
...
# 随笔
    ...
    今天较轻松，怀念了下bonjovi和green day的歌，发现他们竟然都在16年出新单曲了。。听了一下，对green day稍微有点失望,新歌bang bang的单曲关注的是美国的枪支泛滥和恐怖主义，不是说不好，但我们看看以前的歌词：holiday里的歌词有这样的：向美国政府及其走狗行纳粹礼（骂美国政府入侵伊拉克是纳粹），American Idolt，歌名直骂美国人傻叉（讽刺美国人不加判断完全听信美国政府的话，支持入侵伊拉克）等等劲爆但充满反战、反思的歌词，这次的歌曲有点不咸不淡的。。反之bonjovi的歌倒是一如既往的励志。另外他们共同的吸引我的地方就是充满节奏感的音乐和充满画面感的歌词。